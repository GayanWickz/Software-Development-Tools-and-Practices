            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div id="single-property" style="width:1000px; height:700px; margin:30px auto 50px;"> 
                                    <!-- Slide 1-->
                                    <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="auto" height="auto" src="admin/property/<?php echo $row['11'];?>" class="ls-bg" alt="" /> </div>
                                    
                                    <!-- Slide 2-->
                                    <div class="ls-slide" data-ls="duration:7500; transition2d:5; kenburnszoom:in; kenburnsscale:1.2;"> <img width="auto" height="auto" src="admin/property/<?php echo $row['12'];?>" class="ls-bg" alt="" /> </div>
                        ...
                        <div class="property-details">
                            ...
                            <h5 class="mt-5 mb-4 text-secondary">To request your reservation, please click here</h5>
                            <div class="row">
								
								
                                <!-- Reservation Button -->
                                <div class="mt-4">
                               <a id="reservationButton" class="btn btn-success" href="reserve-property.php?pid=<?php echo $row['0']; ?>">Reserve Property</a>
                    ...
                    <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">Location of the Property</h4>
...
// Include the file
include "map for details page/com.php";
?>
...
<script>
    // Retrieve the property ID from the PHP variable directly
    var propertyId = <?php echo $_GET['pid'] ?? 'null'; ?>;
    
    // Fetch the reservation status from the server
    ...
    xhr.onload = function() {
        if (xhr.status === 200) {
            ...
            document.getElementById('reservationStatus').innerText = 'Failed to fetch reservation status.';
        }
    };
    xhr.send();
</script>
