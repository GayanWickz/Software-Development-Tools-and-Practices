...
if(isset($_POST['add']))
{
	...
	bedroom='{$bed}', bathroom='{$bath}',kitchen='{$kitc}',price='{$price}', location='{$loc}', city='{$city}',
	pimage='{$aimage}', pimage1='{$aimage1}', pimage2='{$aimage2}', pimage3='{$aimage3}', pimage4='{$aimage4}',
	status='{$status}', mapimage='{$mapimage}', uid='{$uid}'
	WHERE pid = {$pid}";
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="price" required value="<?php echo $row['8']; ?>">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">City</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="city" required value="<?php echo $row['10']; ?>">
													</div>
												</div>
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="loc" required value="<?php echo $row['9']; ?>">
													</div>
												</div>
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="admin/property/<?php echo $row['11'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="admin/property/<?php echo $row['13'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="admin/property/<?php echo $row['12'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														...
														<img src="admin/property/<?php echo $row['14'];?>" alt="pimage" height="150" width="180">
													</div>
												</div>
