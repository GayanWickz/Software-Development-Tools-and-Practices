                            ...
                            <tr>
                                <td>
                                    ...
                                    <div class="property-info d-table">
                                        ...
                                        <span class="font-14 text-capitalize"><i class="fas fa-map-marker-alt text-success font-13"></i>&nbsp; <?php echo $row['10'];?></span>
                                        <div class="price mt-3">
											<span class="text-success">Rs&nbsp;<?php echo $row['8'];?></span>
										</div>
                                    </div>
								</td>
